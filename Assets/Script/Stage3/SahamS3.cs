...
public class SahamS3
{
    ...
    public void FetchHargaSaham()
    {
        ...
        HtmlNode[] node = doc.DocumentNode.SelectNodes("//span[contains(@class, 'Trsdu(0.3s)') and contains(@class, 'Fw(b)') and contains(@class, 'Fz(36px)') and contains(@class, 'Mb(-4px)') and contains(@class, 'D(ib)')]").ToArray();
        ...
        HtmlNode[] nodeChange = doc.DocumentNode.SelectNodes("//span[contains(@class, 'Trsdu(0.3s)') and contains(@class, 'Fw(500)') and contains(@class, 'Pstart(10px)') and contains(@class, 'Fz(24px)')]").ToArray();
        string changeStr = nodeChange[0].InnerText.ToString();
        int trimpoint;
